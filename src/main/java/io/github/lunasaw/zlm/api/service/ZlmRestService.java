package io.github.lunasaw.zlm.api.service;
...
import io.github.lunasaw.zlm.net.HttpUtils;
...
public class ZlmRestService {
    ...
    private static <T> T executeApiCall(String host, String secret, String apiPath, Map<String, String> params, TypeReference<T> typeRef) {
        ...
        return JsonUtils.fromJson(response, typeRef);
    }

    /**
     * 通用 API 调用处理方法 - 支持请求对象
     *
     * @param host         服务器地址
     * @param secret       密钥
     * @param apiPath      API 路径
     * @param requestObj   请求对象（需要有 toMap 方法）
     * @param typeRef      返回类型引用
    ...
    public static ServerResponse<List<MediaData>> getMediaList(String host, String secret, MediaReq mediaReq) {
        return executeApiCall(host, secret, ApiConstants.GET_MEDIA_LIST, mediaReq, new TypeReference<ServerResponse<List<MediaData>>>() {
        }, MediaReq::toMap);
    }
    ...
    public static ServerResponse<String> closeStream(String host, String secret, MediaReq mediaReq) {
        return executeApiCall(host, secret, ApiConstants.CLOSE_STREAM, mediaReq, new TypeReference<ServerResponse<String>>() {
        }, MediaReq::toMap);
    }
     ...
     * 批量关断流
     */
    public static ServerResponse<Void> closeStreams(String host, String secret, Map<String, String> params) {
        return executeApiCall(host, secret, ApiConstants.CLOSE_STREAMS, params, new TypeReference<ServerResponse<Void>>() {
        });
    }
    ...
    public static ServerResponse<StreamKey> addStreamProxy(String host, String secret, StreamProxyItem streamProxyItem) {
        return executeApiCall(host, secret, ApiConstants.ADD_STREAM_PROXY, streamProxyItem, new TypeReference<ServerResponse<StreamKey>>() {
        }, StreamProxyItem::toMap);
    }
    ...
    public static ServerResponse<StreamKey> addStreamPusherProxy(String host, String secret, StreamPusherItem streamPusherItem) {
        return executeApiCall(host, secret, ApiConstants.ADD_STREAM_PUSHER_PROXY, streamPusherItem, new TypeReference<ServerResponse<StreamKey>>() {
        }, StreamPusherItem::toMap);
    }
    ...
    public static ServerResponse<StreamKey> addFFmpegSource(String host, String secret, StreamFfmpegItem streamFfmpegItem) {
        return executeApiCall(host, secret, ApiConstants.ADD_FFMPEG_SOURCE, streamFfmpegItem, new TypeReference<ServerResponse<StreamKey>>() {
        }, StreamFfmpegItem::toMap);
    }
    ...
    public static MediaOnlineStatus isMediaOnline(String host, String secret, MediaReq mediaReq) {
        return executeApiCall(host, secret, ApiConstants.IS_MEDIA_ONLINE, mediaReq, new TypeReference<MediaOnlineStatus>() {
        }, MediaReq::toMap);
    }
    ...
    public static ServerResponse<MediaPlayer> getMediaPlayerList(String host, String secret, MediaReq mediaReq) {
        return executeApiCall(host, secret, ApiConstants.GET_MEDIA_PLAYER_LIST, mediaReq, new TypeReference<ServerResponse<MediaPlayer>>() {
        }, MediaReq::toMap);
    }
    ...
    public static ServerResponse<String> broadcastMessage(String host, String secret, Map<String, String> params) {
        return executeApiCall(host, secret, ApiConstants.BROADCAST_MESSAGE, params, new TypeReference<ServerResponse<String>>() {
        });
    }
    ...
    public static ServerResponse<Mp4RecordFile> getMp4RecordFile(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.GET_MP4_RECORD_FILE, recordReq, new TypeReference<ServerResponse<Mp4RecordFile>>() {
        }, RecordReq::toMap);
    }
    ...
    public static ServerResponse<String> startRecord(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.START_RECORD, recordReq, new TypeReference<ServerResponse<String>>() {
        }, RecordReq::getSaveMp4Map);
    }
    ...
    public static ServerResponse<String> setRecordSpeed(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.SET_RECORD_SPEED, recordReq, new TypeReference<ServerResponse<String>>() {
        }, RecordReq::getRecordSpeedMap);
    }
    ...
    public static ServerResponse<String> seekRecordStamp(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.SEEK_RECORD_STAMP, recordReq, new TypeReference<ServerResponse<String>>() {
        }, RecordReq::getSeekRecordStampMap);
    }
    ...
    public static ServerResponse<String> stopRecord(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.STOP_RECORD, recordReq, new TypeReference<ServerResponse<String>>() {
        }, RecordReq::getStopRecordMap);
    }
    ...
    public static ServerResponse<String> isRecording(String host, String secret, RecordReq recordReq) {
        return executeApiCall(host, secret, ApiConstants.IS_RECORDING, recordReq, new TypeReference<ServerResponse<String>>() {
        }, RecordReq::getIsRecordingMap);
    }
    ...
    public static String getSnap(String host, String secret, SnapshotReq snapshotReq) {
        return getSnap(host, secret, snapshotReq.toMap(), snapshotReq.savePath());
    }
    ...
    public static OpenRtpServerResult openRtpServer(String host, String secret, OpenRtpServerReq req) {
        return executeApiCall(host, secret, ApiConstants.OPEN_RTP_SERVER, req, new TypeReference<OpenRtpServerResult>() {
        }, OpenRtpServerReq::toMap);
    }
    ...
    public static OpenRtpServerResult openRtpServerMultiplex(String host, String secret, OpenRtpServerReq req) {
        return executeApiCall(host, secret, ApiConstants.OPEN_RTP_SERVER_MULTIPLEX, req, new TypeReference<OpenRtpServerResult>() {
        }, OpenRtpServerReq::toMap);
    }
    ...
    public static OpenRtpServerResult connectRtpServer(String host, String secret, ConnectRtpServerReq req) {
        return executeApiCall(host, secret, ApiConstants.CONNECT_RTP_SERVER, req, new TypeReference<OpenRtpServerResult>() {
        }, ConnectRtpServerReq::toMap);
    }
    ...
    public static StartSendRtpResult startSendRtp(String host, String secret, StartSendRtpReq req) {
        return executeApiCall(host, secret, ApiConstants.START_SEND_RTP, req, new TypeReference<StartSendRtpResult>() {
        }, StartSendRtpReq::toMap);
    }
    ...
    public static StartSendRtpResult startSendRtpPassive(String host, String secret, StartSendRtpReq req) {
        return executeApiCall(host, secret, ApiConstants.START_SEND_RTP_PASSIVE, req, new TypeReference<StartSendRtpResult>() {
        }, StartSendRtpReq::getPassiveMap);
    }
    ...
    public static ServerResponse<String> stopSendRtp(String host, String secret, CloseSendRtpReq req) {
        return executeApiCall(host, secret, ApiConstants.STOP_SEND_RTP, req, new TypeReference<ServerResponse<String>>() {
        }, CloseSendRtpReq::getMap);
    }
    ...
    private static PlayUrl generatePlayUrls(String host, String secret, MediaReq mediaReq) {
        String app = mediaReq.app();
        String stream = mediaReq.stream();
        ...
        if (configResponse != null && configResponse.data() != null && !configResponse.data().isEmpty()) {
            ServerNodeConfig config = configResponse.data().getFirst();
        ...
        // 生成不同协议的播放地址
        return new PlayUrl(
                String.format("rtsp://%s:%s/%s/%s", baseHost, rtspPort, app, stream),
                String.format("rtmp://%s:%s/%s/%s", baseHost, rtmpPort, app, stream),
                String.format("http://%s:%s/%s/%s.live.flv", baseHost, httpPort, app, stream),
                String.format("ws://%s:%s/%s/%s.live.flv", baseHost, httpPort, app, stream),
                String.format("http://%s:%s/%s/%s/hls.m3u8", baseHost, httpPort, app, stream),
                String.format("http://%s:%s/%s/%s.live.ts", baseHost, httpPort, app, stream),
                String.format("ws://%s:%s/%s/%s.live.ts", baseHost, httpPort, app, stream),
                String.format("http://%s:%s/%s/%s.live.mp4", baseHost, httpPort, app, stream),
                String.format("ws://%s:%s/%s/%s.live.mp4", baseHost, httpPort, app, stream)
        );
    }
    ...
    public static String getSnap(String host, String secret, Map<String, String> params, String file) {
        ...
        return doApiImg(host, secret, ApiConstants.GET_SNAP, params, path);
    }
    ...
    public static String doApi(String host, String secret, String path, Map<String, String> params) {
        ...
        return HttpUtils.doPostHandler(host, path, new HashMap<>(), params, "");
    }

    public static String doApiImg(String host, String secret, String apiPath, Map<String, String> params, Path file) {
        Assert.notNull(host, "host is null");
        Assert.notNull(apiPath, "api is null");
        Assert.notNull(secret, "secret is null");

        params = Optional.ofNullable(params).orElse(new HashMap<>());
        params.put("secret", secret);
        ClassicHttpResponse classicHttpResponse = HttpUtils.doPost(host, apiPath, new HashMap<>(), params, "");
