...
public class ZlmHookController {
    ...
    @ApiResponse(responseCode = "200", description = "处理成功", content = @Content(schema = @Schema(implementation = HookResultForGeneral.class)))
    @PostMapping(ON_FLOW_REPORT)
    public HookResultForGeneral onFlowReport(@Parameter(description = "流量统计参数") @RequestBody HookParamForOnFlowReport param) {
    ...
    @ApiResponse(responseCode = "200", description = "鉴权成功", content = @Content(schema = @Schema(implementation = HookResultForGeneral.class)))
    @PostMapping(ON_PLAY)
    public HookResultForGeneral onPlay(@Parameter(description = "播放鉴权参数") @RequestBody
    ...
    public HookResultForGeneral onRecordMp4(@Parameter(description = "MP4 录制参数") @RequestBody
    ...
    public HookResultForGeneral onShellLogin(@Parameter(description = "Shell 鉴权参数") @RequestBody
    ...
    public HookResultForGeneral onStreamChanged(@Parameter(description = "流状态变化参数") @RequestBody
    ...
    public HookResultForGeneral onStreamNotFound(@Parameter(description = "流未找到参数") @RequestBody
    ...
    public HookResultForGeneral onServerStarted(@Parameter(description = "服务器配置参数") @RequestBody
    ...
    public HookResultForGeneral onServerExited(@Parameter(description = "钩子参数") @RequestBody
    ...
    public HookResultForGeneral onServerKeepalive(@Parameter(description = "服务器心跳参数") @RequestBody
    ...
    public HookResultForGeneral onSendRtpStopped(@Parameter(description = "RTP 发送停止参数") @RequestBody
    ...
    public HookResultForGeneral onRtpServerTimeout(@Parameter(description = "RTP 服务器超时参数") @RequestBody
     ...
     */
    private <T> HookResultForGeneral handleAsyncHookEvent(String hookName, T param, Consumer<T> consumer) {
        try {
            log.trace("{} param = {}", hookName, param);
            executor.execute(() -> {
                try {
